...
Run 5 generations of ABC-SMC, with starting tolerances of 220,000 for the two sum-of-squares metrics, and 40 for the final epidemic size and time of the final removal metrics. Summarise your approximate posteriors, and the posteriors for $R_0$, the mean latent period and the mean infectious period.
```
