...
```{r, boot-extrun, fig.width = 5, fig.height = 5}
...
Here the variance is `r round(flu_train, 2)`, which is much larger than 3. Hence let's try increasing the number of particles and repeating these steps.
