...
```{r, sim-run}
## define parameters
simPars <- c(beta = 3.7, muI = 2.2, muB = 0.78)
...
Here we can see that the epidemic is still going at time point `t = 14`, but that there are no more infectives left, so the epidemic will complete shortly (once the remaining individual in the $B$ class moves to the $C$ class).
