...
Here we will explore fitting a simple $SIR$ model to the famous Abakaliki smallpox data (see e.g.  [@oneill_roberts:1999]). Firstly, load the `SimBIID` library:
...
post <- ABCSMC(data, priors, simSIR, iniStates, 50, tols, ptol = 0.2, ngen = 3, parallel = T, model = model)
``
