...
## set knitr options
opts_chunk$set(cache = T, tidy.opts = list(width.cutoff = 55), tidy = F, fig.align = "center", out.width = "60%", multCode = F, dev = ifelse(opts_knit$get("rmarkdown.pandoc.to") == "latex", "pdf", "svg"))
