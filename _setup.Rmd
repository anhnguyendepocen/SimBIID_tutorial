...
## set knitr options
opts_chunk$set(cache = T, tidy.opts = list(width.cutoff = 55), tidy = F, fig.align = "center", fig.width = ifelse(opts_knit$get("rmarkdown.pandoc.to") == "latex", 4.3, 5), fig.height = fig.width, multCode = F)
